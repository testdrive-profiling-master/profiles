...
create_hw_cfgmem -hw_device [lindex [get_hw_devices xcku060_0] 0] [lindex [get_cfgmem_parts {mx25l25673g-spi-x1_x2_x4}] 0]
...
set_property PROGRAM.FILES [list "system_design.mcs" ] [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xcku060_0] 0]]
set_property PROGRAM.PRM_FILE [list "system_design.prm"] [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xcku060_0] 0]]
...
set_property PROGRAM.CHECKSUM  0 [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xcku060_0] 0]]
startgroup
create_hw_bitstream -hw_device [lindex [get_hw_devices xcku060_0] 0] [get_property PROGRAM.HW_CFGMEM_BITFILE [ lindex [get_hw_devices xcku060_0] 0]]; program_hw_devices [lindex [get_hw_devices xcku060_0] 0]; refresh_hw_device [lindex [get_hw_devices xcku060_0] 0];
