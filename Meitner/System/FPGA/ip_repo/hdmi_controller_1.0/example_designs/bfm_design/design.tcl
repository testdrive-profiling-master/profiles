proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI_LITE] [get_bd_intf_pins hdmi_controller_0/S_AXI]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_0/M_AXI_LITE_ACLK] [get_bd_pins hdmi_controller_0/S_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_0/M_AXI_LITE_ARESETN] [get_bd_pins hdmi_controller_0/S_AXI_ARESETN]
	...
	set offset_file "${bd_path}/hdmi_controller_v1_0_tb_include.vh"
...
set test_bench_file ${ip_path}/example_designs/bfm_design/hdmi_controller_v1_0_tb.v
