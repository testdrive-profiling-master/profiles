...
verilator_bin %SIM_TOP_FILE% %1 %2 %3 %4 %SIM_DEFINITION% -sv -cc --autoflush --compiler gcc --output-split 100000 -Mdir %PROJECT%System/SubSystems/Simulation/verilator -prefix SimTop --top-module top
ENDLOCAL