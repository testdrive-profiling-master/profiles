...
LIBDIR			:= -L$(TESTDRIVE_PROFILE)Common/utils/lib -lwebgui -lshlwapi -lole32 -lversion -lmicrohttpd -lWs2_32 -lgdi32 `pkg-config --libs-only-l jsoncpp` -lUtilFramework -liconv $(LIBDIR)
