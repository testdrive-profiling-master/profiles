...
class ASResource
{
    public:
        ...
        static const string AS_DO, AS_BEGIN, AS_GENERATE, AS_CASE, AS_CASEX, AS_CASEZ, AS_FUNCTION, AS_FORK, AS_TABLE, AS_TASK, AS_SPECIFY, AS_PRIMITIVE, AS_MODULE; // add verilog
