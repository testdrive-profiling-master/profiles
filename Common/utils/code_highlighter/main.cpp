...
int main(int argc, const char* argv[])
{
	...
	main_arg_table.AddOptionInt("start_number", 1, "i", NULL, "start_number", "set start line number");
	main_arg_table.AddRemark(NULL, "default : 1");
	...
	{	// do right thing...
		...
		if(main_arg_table.GetOption("line_number")) {
			...
			sourceHighlight.setLineNumberDigits(main_arg_table.GetOptionInt("start_number"));
		}
